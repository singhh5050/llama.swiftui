        ...
        NavigationView {
            VStack {
                        ...
                        TextEditor(text: $customSystemPrompt)
                            ...
                            .onAppear {
                                if customSystemPrompt.isEmpty {
                                    customSystemPrompt = ModelStopTokens.defaultSystemPrompt
                                }
                            }
                        HStack {
                            ...
                            Spacer()
                            Button("Apply") {
                                llamaState.setCustomSystemPrompt(customSystemPrompt)
                ...
                HStack(spacing: 20) {
                    ...
                    NavigationLink(destination: BenchmarkView(llamaState: llamaState)) {
                        Text("Benchmark")
                    }
                }
                .padding()
